...
const Home = () =>{
  ...
  return (
   ...
   <div className=" font-semibold text-[#012970] text-lg col-start-1 col-end-13 row-start-3 row-end-4 pl-12  pt-4 " >
    <h1>IS3116 Database Management System Attendance Report - 2023.07.25</h1>
   </div>

   <div className=" text-center  col-start-5 col-end-7 row-start-5 row-end-7 ">
    <h1 className="bg-[#012970] text-white rounded-[5px] w-[250px] h-[28px] ">Total Present Students - 85</h1>
  
    <h1 className="bg-[#989797] text-dark-blue rounded-[5px] w-[250px] h-[28px] mt-5 ">Total Absent Students - 28</h1>
   </div>

   <div className=" text-white text-center text-sm col-start-11 col-end-12 row-start-4 row-end-5 ">
    <button className="bg-light-blue w-[210px] h-[50px] rounded-[5px] ">Download Report</button>
   </div>
  ...
  <div className="  col-start-1 col-end-13 row-start-7 row-end-8 pl-12  pt-10 ">
    <h1 className="text-xl font-semibold text-dark-blue bg-#F0F4FB" > Student attendance Details for this month</h1>
